                        ...
                        for (int l4 = 0; l4 < childInterface.width; l4++) {
                            ...
                            if (i3 < childInterface.inv.length && childInterface.inv[i3] > 0) {
                                ...
                                if (k5 > DrawingArea.topX - 32 && k5 < DrawingArea.bottomX && j6 > DrawingArea.topY - 32 && j6 < DrawingArea.clipBottom || activeInterfaceType != 0 && selectedInventorySlot == i3) {
                                    ...
                                    if (childInterface.id == 23187  || childInterface.id == 23387  || childInterface.id == 23587  || childInterface.id == 23787  || childInterface.id == 23511) {
...
//System.out.println((getScreenHeight() - 503) / 2+" inarea");
                ...
                if (obj instanceof NPC) {
                    ...
                    if (spriteDrawX > -1) {
                        ...
                        if (entityDef.id == 1821) {
                            spritesMap.get(1712).drawSprite(spriteDrawX - 15, spriteDrawY - 55);
                        ...
                        if (spriteDrawX > -1) {
                            ...
                            if(Configuration.DISPLAY_PRESTIGES)
                                if (player.prestigeIcon > 0 && player.prestigeIcon < player.maxprestiges) {//here
                                    spritesMap.get(1709 + player.prestigeIcon).drawSprite(spriteDrawX - 18, spriteDrawY - l - 23);//here just chang
                                    newSmallFont.drawCenteredString("@red@Prestige: @whi@"+player.prestigeIcon, spriteDrawX, spriteDrawY - l + 20 , 0x15FF00, 0x000000);
    ...
    public void drawCombatBox(int xPos, int yPos, int width, int height, int currentHp, int maxHp, int hpBarXPps) {
        ...
        if (maxHp > 0) {
            newBoldFont.drawCenteredString((int) percentOfHpLeft + "%", xPos + (width / 2), hpBarYPos + 13, 16777215, 0);
        } else {
