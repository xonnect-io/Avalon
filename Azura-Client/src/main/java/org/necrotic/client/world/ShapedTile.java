...
public final class ShapedTile {
	...
	public ShapedTile(int i, int j, int k, int l, int overlaytex, int underlaytex, int j1, int k1, int l1, int i2, int j2, int k2, int l2, int i3, int j3, int k3, int l3, int i4, int k4, int l4, boolean tex) {
		color61 = l1;
		color71 = i4;
		color81 = j2;
		color91 = k;
