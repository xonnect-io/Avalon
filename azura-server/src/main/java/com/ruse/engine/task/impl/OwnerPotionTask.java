...
public class OwnerPotionTask extends Task {
	...
	public void execute() {
		...
		Consumables.overloadIncrease(player, Skill.ATTACK, 1.00);
		Consumables.overloadIncrease(player, Skill.STRENGTH, 1.00);
		Consumables.overloadIncrease(player, Skill.DEFENCE, 1.00);
		Consumables.overloadIncrease(player, Skill.RANGED, 1.00);
		Consumables.overloadIncrease(player, Skill.MAGIC, 1.00);
