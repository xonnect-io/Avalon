                    ...
                    public void execute() {
                        ...
                        switch (id) {
                            ...
                            case 12809:
                                ...
                                break;
                            case 12006:
                                if (player.getLocation () == Location.FANTASY_ZONE)
                                    FantasyZone.pickMushroom (player, gameObject);
                                break;
                            case 4388:
                            ...
                            case 8689:
                                if (player.getInventory ().contains (3727)) {
                                    ...
                                    player.getPacketSender ().sendMessage ("You need a bucket to collect milk from Betsy");
                                break;
                            case 25214:
                                if (!player.isMembershipUnlocked ()) {
                                    ...
                                    return;
                                } else if (player.isMembershipUnlocked ())
                            ...
                            case 11354:
                                ...
                                } else if (player.getTalkedToGhost () == false)
                        ...
                        /*    case 423:
                            ...
                            case 28714:
                                player.performAnimation (new Animation (828));
                                player.delayedMoveTo (new Position (3110, 2990), 2);
                                break;
                            case 26933:
                                player.performAnimation (new Animation (827));
