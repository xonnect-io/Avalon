...
public class Achievements {
    ...
    public enum Achievement {
        ...
        // EASY
        VOTE_10_TIMES(1, 625, AchievementDifficulty.EASY, "Vote for Avalon 10 times by using the ::vote command!", 10, new String[][]{}, new Item(ItemDefinition.COIN_ID, 10_000_000)),
        ...
        // MEDIUM
        VOTE_50_TIMES(1, 625, AchievementDifficulty.MEDIUM, "Vote for Avalon 50 times by using the ::vote command!", 50, new String[][]{}, new Item(ItemDefinition.COIN_ID, 50_000_000)),
