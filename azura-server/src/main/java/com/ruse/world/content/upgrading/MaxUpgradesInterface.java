...
public class MaxUpgradesInterface {
    ...
    enum CustomCombinerData {
        ...
        BLOOD_STAFF(30,new Item(22114,-1),new Item(23227, 1),new Item(22114, 1),new Item(17013, 1), new Item(23239, 1), new Item(5022, 10_000_000), new Item(12855, 35_000_000)),
        ...
        DRAGON_RIDER_SET(100,new Item(14050,-1),new Item(23456, 1),new Item(14050, 1),new Item(14051, 1),new Item(14052, 1),new Item(14053, 1),new Item(14055, 1),new Item(12855, 5000000)),
