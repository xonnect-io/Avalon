...
public enum Upgradeables {
    ...
    D_HELMET(TIER_1, new Item(4716, 1), new Item(13996, 1), 125, 60),
    D_CHAINBODY(TIER_1, new Item(4720, 1), new Item(13913, 1), 125, 60),
    D_PLATESKIRT(TIER_1, new Item(4722, 1), new Item(13919, 1), 125, 60),
    D_BOW(TIER_1, new Item(11235, 1), new Item(18799, 1), 125, 60),
    X_HELMET(TIER_1, new Item(4732, 1), new Item(18834, 1), 125, 60),
    X_CHESTPLATE(TIER_1, new Item(4736, 1), new Item(18801, 1), 125, 60),
    X_CHAINSKIRT(TIER_1, new Item(4738, 1), new Item(18800, 1), 125, 60),
    SOL(TIER_1, new Item(15486, 1), new Item(5095, 1), 125, 60),
    A_HELM(TIER_1, new Item(4708, 1), new Item(19140, 1), 125, 60),
    A_BODY(TIER_1, new Item(4712, 1), new Item(19139, 1), 125, 60),
    A_LEGS(TIER_1, new Item(4714, 1), new Item(19138, 1), 125, 60),
    FIRECAPE(TIER_1, new Item(6570, 1), new Item(4411, 1), 125, 60),
    DEFENDER(TIER_1, new Item(13262, 1), new Item(19887, 1), 125, 60),
    CMAUL(TIER_1, new Item(18353, 1), new Item(22078, 1), 125, 60),
    DBOOTS(TIER_1, new Item(11732, 1), new Item(19123, 1), 125, 60),
