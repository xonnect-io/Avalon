...
public class SkillManager {
    ...
    public SkillManager addExperience(Skill skill, int experience) {
         ...
         * FARMING* 20 RUNECRAFTING* 21 INVENTION 22 HUNTER* 23 SUMMONING* 24
         * DUNGEONEERING
         */
        ...
        if (Misc.percentageChance(0.01)) { //Change the value. This is a 10% change of a spawn - Way too high.
            Genie.spawn(player);
        }
