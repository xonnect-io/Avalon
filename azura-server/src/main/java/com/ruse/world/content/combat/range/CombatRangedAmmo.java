...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		AOEWEAPONS(new int[] {3738 }, new AmmunitionData[] { AmmunitionData.AOE_AMMO },
				RangedWeaponType.BSOAT),
		MINIGUN(new int[] { 11235,19137, 19136,23226, 19843, 9941,23228,15872, 5012, 18636,8088,5073,23785,8411,5011,22113,5010,8001,21606,15785,14919, 8253,22089,7543,9929,14056, 20173, 671, 16879,18332,17672, 22083 },
