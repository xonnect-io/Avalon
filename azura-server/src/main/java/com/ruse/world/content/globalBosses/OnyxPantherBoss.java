...
public class OnyxPantherBoss {

    public static NPC currentBoss = null;

    public static int tick = 0;

    public static Position SPAWN_POINT = new Position(2470, 5432,0);
    ...
    public static void initiateSpawn() {
        ...
        if (tick % 18000 == 0) {
            ...
            if(currentBoss == null || currentBoss.isDying() || !currentBoss.isRegistered()) {
                ...
                World.sendBroadcastMessage("Onyx Panther has appeared ::onyx");
                GameSettings.broadcastMessage = ("Onyx Panther has appeared ::onyx");;
