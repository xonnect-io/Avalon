...
public enum RewardsData {
	...
	ASSASIN_BOX(1,
			...
			"Drop Rate Box"),
	BaphometBox(2,
			new int[] { 4882, 4894, 4900, 4888, 20460, 20456, 18747, 19582, 14525, 11858, 6199, 23020,
					18740, 23020, 4153, 1215, 4151, 18684, 18686, 3140, 15332 },
			"PvM crate"),
	DonatorBox(3,
			new int[] { 11235, 17273, 14484, 18685, 11696, 11698, 11700, 12933, 15486, 19336, 18358, 19337, 19338,
			...
			"Vote Box"),
	DonkeyBox(4,
			new int[] { 11235, 17273, 14484, 18685, 3324, 11696, 11698, 11700, 12933, 15486, 19336, 19337, 19338, 19339,
	...
	GodzillaBOX(5,
			new int[] { 1055, 1053, 1507, 1050, 10284, 962, 1042, 1046, 1044, 1040, 1038, 11858, 11860, 11862, 19580,
					10935, 6769, 11235, 17273, 14484, 11696, 11698, 11700, 12933, 15486, 19336, 19337, 19338, 19339,
					19340, 14009, 14010, 14008, 6769, 6739, 13744, 13738, 13742, 13740, 6570, 19111, 11702, 13752,
					13746, 13750, 19135, 14484 },
			"Extreme MBox"),
	Infernal_Groudon(6,
			new int[] { 19886, 9000, 5497, 19812, 19843, 14769, 6199, 6199, 4178, 20534, 19116, 19115, 19114, 19119,
