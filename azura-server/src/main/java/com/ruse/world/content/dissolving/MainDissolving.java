...
public class MainDissolving {
	...
	public enum DissolvingData {
		...
		FLAMETHRO_NOTE(17713, new Item[]{new Item(orb, 2854)}, 12854, anim),
		...
		SWOODOO(19149, new Item[]{new Item(orb, 6000)}, 16000, anim),
		SWOODOO_NOTE(19150, new Item[]{new Item(orb, 6000)}, 16000, anim),
		SWOODOO_2(12930, new Item[]{new Item(orb, 6000)}, 16000, anim),
		SWOODOO_3(4405, new Item[]{new Item(orb, 6000)}, 16000, anim),
		SWOODOO_3_NOTE(4406, new Item[]{new Item(orb, 6000)}, 16000, anim),
		...
		BARROW1(14499, new Item[]{new Item(orb, 50)}, 150, anim),
		BARROW2(14497, new Item[]{new Item(orb, 50)}, 150, anim),
		BARROW3(14501, new Item[]{new Item(orb, 50)}, 150, anim),
		BARROW4(4710, new Item[]{new Item(orb, 50)}, 150, anim),
		BARRO5(10350, new Item[]{new Item(orb, 50)}, 150, anim),
		BARRO6(10348, new Item[]{new Item(orb, 50)}, 150, anim),
		BARRO7(10346, new Item[]{new Item(orb, 50)}, 150, anim),
		...
		BARROW23(16054, new Item[]{new Item(orb, 50)}, 150, anim),
		BARROW34(4734, new Item[]{new Item(orb, 50)}, 150, anim),
		BARROW35(17193, new Item[]{new Item(orb, 50)}, 150, anim),
		BARROW37(17339, new Item[]{new Item(orb, 50)}, 150, anim),
		...
		STAFF_OF_FESTIVE(14924, new Item[]{new Item(orb, 500)}, 5200, anim),
		NATURE_BOW(14919, new Item[]{new Item(orb, 500)}, 5200, anim),
		DEMNIC_SWORD(14915, new Item[]{new Item(orb, 500)}, 5200, anim),
		...
		DRAGON99(15031, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON939(15259, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON9339(15260, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON12(1150, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON92(6740, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON22(1250, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON32(3205, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON42(1306, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON52(1216, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON62(1378, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON72(1435, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON82(7159, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON822(1304, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON8232(1305, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON113(1434, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON8233(1435, new Item[]{new Item(orb, 15)}, 150, anim),
		DRAGON992(15032, new Item[]{new Item(orb, 15)}, 150, anim),
