...
public class MainDissolving {
	...
	public enum DissolvingData {
		...
		DEMONAGGER(15877, new Item[]{new Item(UPG_TOKEN, 620)}, 1620, anim),
		...
		DEMONBOOTS(16269, new Item[]{new Item(UPG_TOKEN, 350)}, 1000, anim),
		DEMONGLOVES(15943, new Item[]{new Item(UPG_TOKEN, 350)}, 1000, anim),
