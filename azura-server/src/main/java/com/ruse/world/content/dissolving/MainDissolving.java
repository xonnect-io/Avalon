...
public class MainDissolving {
	...
	public enum DissolvingData {
		...
		brutalwhip(22077, new Item[]{new Item(UPG_TOKEN, 1000)}, 1240, anim),
		brutalstaff(6936, new Item[]{new Item(UPG_TOKEN, 1000)}, 1240, anim),
		brutalbow(19136, new Item[]{new Item(UPG_TOKEN, 1000)}, 1240, anim),
		...
		KINGHELM(15922, new Item[]{new Item(UPG_TOKEN, 1999)}, 11999, anim),
		KINGLEGS(15933, new Item[]{new Item(UPG_TOKEN, 1999)}, 11999, anim),
		KINGOBDY(16021, new Item[]{new Item(UPG_TOKEN, 1999)}, 11999, anim),
		BULWARKHELM(8816, new Item[]{new Item(UPG_TOKEN, 1999)}, 11999, anim),
		BULWARKBODY(8817, new Item[]{new Item(UPG_TOKEN, 1999)}, 11999, anim),
		BULWARKLEGS(8818, new Item[]{new Item(UPG_TOKEN, 1999)}, 11999, anim),
