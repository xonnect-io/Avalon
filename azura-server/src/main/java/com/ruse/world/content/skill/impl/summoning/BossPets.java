...
public class BossPets {
	...
	public enum BossPet {
		...
		RAMMUS_PET(9822, 23164, 400,"100% key drop & 25% DR Bonus"),
		DEMON_PET(9819, 23161, 300,"100% key drop & 25% DR Bonus"),
		GOLEM_PET(9821, 23163, 400,"100% key drop & 25% DR Bonus"),
		DRAGON_PET(9820, 23162, 1500,"100% key drop & 25% DR Bonus"),
