...
public class DefaultRangedCombatStrategy implements CombatStrategy {
	...
	private boolean checkAmmo(Player player) {
		...
		if (player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 22010
				...
				|| player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 17672
				...
				|| player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 15872
				...
				|| player.getEquipment().get(Equipment.WEAPON_SLOT).getId() == 23226) { // ||
