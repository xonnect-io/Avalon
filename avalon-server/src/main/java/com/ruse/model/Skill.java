...
public enum Skill {
	...
	CONSTITUTION(6216, 1, 1, 9768, 9769, -1, 10000, 188, 150, 113, 75, 113), // done
	RANGED(4443, 1, 9, 9756, 9757, -1, 10000, 188, 150, 113, 75, 113), // done
	PRAYER(6242, 1, 12, 9759, 9760, 22014, 10000, 188, 150, 113, 75, 113), // done
	MAGIC(6211, 1, 15, 9762, 9763, -1, 10000, 188, 150, 113, 75, 113), // done
	...
	FLETCHING(6231, 1, 16, 9783, 9784, 22021, 10000, 156, 125, 94, 62, 94), // done
	FISHING(6258, 1, 8, 9798, 9799, -1, 10000, 81, 65, 49, 32, 85), // done
	FIREMAKING(4282, 1, 14, 9804, 9805, 22029, 10000, 93, 75, 56, 37, 56), // done
	CRAFTING(6263, 1, 13, 9780, 9781, 22020, 10000, 118, 95, 71, 47, 71), // done
	SMITHING(6221, 1, 5, 9795, 9796, 22026, 10000, 125, 100, 75, 50, 85), // done
	MINING(4416, 1, 2, 9792, 9793, -1, 10000, 125, 100, 75, 50, 85), // done
	HERBLORE(6237, 1, 7, 9774, 9775, 22018, 10000, 131, 105, 79, 53, 79), // done
	AGILITY(4277, 1, 4, 9771, 9772, 22017, 10000, 94, 75, 56, 38, 75), // done
	THIEVING(4261, 1, 10, 9777, 9778, 22019, 10000, 170, 136, 102, 68, 102), // done
	SLAYER(12122, 1, 19, 9786, 9787, 22022, 10000, 188, 150, 113, 75, 5), // done
	FARMING(5267, 1, 20, 9810, 9811, 22031, 10000, 89, 71, 53, 35, 53), // done
	RUNECRAFTING(4267, 1, 18, 9765, 9766, 22015, 10000, 130, 104, 78, 52, 78), // done
	INVENTION(7267, 1, 21, 9789, 9790, -1, 1, 1, 1, 1, 1, 1), // done
	HUNTER(8267, 1, 22, 9948, 9949, 22024, 10000, 131, 105, 79, 53, 79), // done
	SUMMONING(9267, 1, 23, 12169, 12170, 22033, 10000, 134, 107, 80, 54, 80), // done
